...
public class WeekdayArrayAdapter extends ArrayAdapter<String> {
	public static int textColor = Color.parseColor("#EBEBEB");
...
//		}
		...
		textView.setBackgroundColor(Color.parseColor("#A07941"));
		textView.setShadowLayer(1.0f, 1.0f, 1.0f, Color.parseColor("#203222"));
